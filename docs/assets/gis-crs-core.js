...
window.EditPolygonCRS=Object.freeze({version:'1.44.1',normalise:norm,parse,catalog,transformCoordinate,transformGeometry,transformFeatureCollection,detectGeoJSONCrs,detectWktCrs,prepareGeoJSON,wktDefinition,geometryToWkt,utmForLonLat,bboxCenter,supported:c=>!!parse(c)});
})();
