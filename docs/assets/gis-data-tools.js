...
function click(event){
  ...
  else if(action==='clear-filter'){api().setFilter(layerId,null);filterDraft={version:1,logic:'and',conditions:[blankCondition(layer)]};status('Filter cleared.','ok');render('filter');}
