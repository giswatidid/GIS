...
function ensureProcessingRuntime(){
  ...
  if(!self.EditPolygonGISProcessingRegistry)importScripts('gis-processing-registry.js?v=20260812-v15603-processing-tool-list-ui');
  if(!self.EditPolygonGISProcessingCore)importScripts('gis-processing-core.js?v=20260812-v15603-processing-tool-list-ui');
