...
function openLayerMenu(e,id,s){
  ...
  const analysisItems=menuAction('select','Select features',selectedBadge)+menuAction('filter','Filter',filterBadge)+menuAction('join','Join & summarize')+menuAction('health','Check & fix geometry')+menuAction('process','Processing');
