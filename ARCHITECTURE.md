...
This document describes the current application architecture as of **v1.55.4.16**, retaining the v1.55.4 dual-engine parity/quality architecture baseline before OpenLayers becomes the default renderer.
