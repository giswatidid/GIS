...
This document describes the current application architecture as of **v1.55.4.9**, retaining the v1.55.4 dual-engine parity/quality architecture baseline before OpenLayers becomes the default renderer.
...
GIS XYZ/TMS/WMS creation and runtime visibility/opacity/z-order also use the map contract.
