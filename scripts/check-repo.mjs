...
for(const token of ['editpolygon-leaflet-compat','__peGetLeafletMap','__polygonEditorLeafletMap','getLegacyMap','syncLegacy'])if(app.includes(token)||adapter.includes(token))throw new Error('Obsolete OpenLayers compatibility-map token remains: '+token);
