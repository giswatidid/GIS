...
const RELEASE_KEY='20260811-v1560-processing-toolbox';
...
function fail(message){throw new Error(`v1.56.0 runtime/repository audit: ${message}`);}
...
if(pkg.version!=='1.56.0')fail(`package version is ${pkg.version}, expected 1.56.0`);
...
// must not reappear.
requireToken(adapter,"const VERSION='1.56.0';",'map adapter version');
...
requireToken(app,'// v1.56.0: OpenLayers is the sole map runtime. Application code talks only','application runtime boundary');
...
const authority='/* v1.56.0 — runtime authority boundary.';
...
requireToken(authorityTail,"version:'1.56.0'",'runtime authority snapshot');
...
requireToken(mobile,"const VERSION='1.56.0';",'mobile controller version');
...
// v1.56.0 Processing Toolbox invariants: one declarative registry, one shared
...
for(const token of ['EditPolygonGISProcessingCore.executeWithTurf','gis-processing-registry.js?v=20260811-v1560-processing-toolbox','gis-processing-core.js?v=20260811-v1560-processing-toolbox'])requireToken(processingWorker,token,'shared processing worker execution');
requireToken(app,"new Worker('assets/gis-processing-worker.js?v=20260811-v1560-processing-toolbox')",'processing worker cache key');
...
requireToken(html,'gis-processing-registry.js?v=20260811-v1560-processing-toolbox','processing registry deployment');
requireToken(html,'gis-processing-core.js?v=20260811-v1560-processing-toolbox','processing core deployment');
requireToken(html,'gis-processing.js?v=20260811-v1560-processing-toolbox','processing UI deployment');
requireToken(html,'gis-processing.css?v=20260811-v1560-processing-toolbox','processing CSS deployment');
...
requireToken(app,"EditPolygonProjectFormat.createArchive(payload,{appVersion:'1.56.0'})",'EPZ save version');
...
console.log('v1.56.0 runtime/repository audit passed. OpenLayers authority remains intact and the declarative browser-local Processing Toolbox is wired through one validated worker lifecycle.');
