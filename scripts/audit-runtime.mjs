...
const RELEASE_KEY='20260812-v15603-processing-tool-list-ui';
...
function fail(message){throw new Error(`v1.56.0.4 runtime/repository audit: ${message}`);}
...
if(pkg.version!=='1.56.0.4')fail(`package version is ${pkg.version}, expected 1.56.0.4`);
...
// must not reappear.
requireToken(adapter,"const VERSION='1.56.0.4';",'map adapter version');
...
requireToken(app,'// v1.56.0.4: OpenLayers is the sole map runtime. Application code talks only','application runtime boundary');
...
const authority='/* v1.56.0.4 — runtime authority boundary.';
...
requireToken(authorityTail,"version:'1.56.0.4'",'runtime authority snapshot');
...
requireToken(mobile,"const VERSION='1.56.0.4';",'mobile controller version');
...
// v1.56.0.4 Processing Toolbox invariants: one declarative registry, one shared
...
for(const token of ['EditPolygonGISProcessingCore.executeWithTurf','gis-processing-registry.js?v=20260812-v15603-processing-tool-list-ui','gis-processing-core.js?v=20260812-v15603-processing-tool-list-ui'])requireToken(processingWorker,token,'shared processing worker execution');
requireToken(app,"new Worker('assets/gis-processing-worker.js?v=20260812-v15603-processing-tool-list-ui')",'processing worker cache key');
...
requireToken(html,'gis-processing-registry.js?v=20260812-v15603-processing-tool-list-ui','processing registry deployment');
requireToken(html,'gis-processing-core.js?v=20260812-v15603-processing-tool-list-ui','processing core deployment');
requireToken(html,'gis-processing.js?v=20260812-v15603-processing-tool-list-ui','processing UI deployment');
requireToken(html,'gis-processing.css?v=20260812-v15603-processing-tool-list-ui','processing CSS deployment');
...
requireToken(app,"EditPolygonProjectFormat.createArchive(payload,{appVersion:'1.56.0.4'})",'EPZ save version');
...
console.log('v1.56.0.4 runtime/repository audit passed. OpenLayers authority remains intact and the declarative browser-local Processing Toolbox is wired through one validated worker lifecycle.');
